...
import { SearchOutlined, BarsOutlined, CloseOutlined, SaveOutlined, DeleteFilled, EditFilled, ExclamationCircleOutlined, ToolTwoTone } from '@ant-design/icons';
...
class Day extends Component {
    ...
    getInformation = async () => {
        await axios.get('http://localhost:3001/api/Day')
            .then(response => {
